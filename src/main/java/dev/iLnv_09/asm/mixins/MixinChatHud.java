...
import dev.iLnv_09.asm.accessors.IChatHud;
import dev.iLnv_09.mod.modules.impl.client.ClientSetting;
import dev.iLnv_09.api.interfaces.IChatHudHook;
...
public abstract class MixinChatHud implements IChatHudHook {
    ...
    private int get(int i) {
        ...
        if (map != null && last != null && !map.containsKey(last)) {
    ...
    @Unique private ArrayList<FadeUtils> messageTimestamps;
