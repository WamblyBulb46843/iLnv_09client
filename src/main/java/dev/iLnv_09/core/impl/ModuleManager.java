...
import dev.iLnv_09.mod.modules.impl.combat.*;
import dev.iLnv_09.mod.modules.impl.exploit.*;
import dev.iLnv_09.mod.modules.impl.misc.*;
import dev.iLnv_09.mod.modules.impl.movement.*;
import dev.iLnv_09.mod.modules.impl.player.*;
import dev.iLnv_09.mod.modules.impl.player.freelook.FreeLook;
import dev.iLnv_09.mod.modules.impl.render.*;
import dev.iLnv_09.mod.modules.impl.render.skyBox.SkyBox;
...
public class ModuleManager implements Wrapper {
    ...
    public ModuleManager() {
        ...
        addModule(new AutoDM());
        addModule(new ChestClearer());
        ...
        addModule(new LollipopMapScannerV2());
        addModule(new SimpleElytraFlyPath());
        addModule(new IRCModule());
        addModule(new findbase());
        ...
        addModule(new TipTapShow());
        addModule(new PlayerAlert());
        addModule(new Zoom());
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        iLnv_09.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
