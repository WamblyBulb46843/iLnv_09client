...
import dev.iLnv_09.mod.modules.impl.client.HUD;
import dev.iLnv_09.mod.modules.impl.client.ModuleList;
...
public class ConfigManager extends Manager {
	...
	public static void resetModule() {
		for (Module module : iLnv_09.MODULE.modules) {
	...
	public void loadSettings() {
		for (Module module : iLnv_09.MODULE.modules) {
			...
			module.setState(iLnv_09.CONFIG.getBoolean(module.getName() + "_state", module instanceof HUD || module instanceof ModuleList));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + iLnv_09.PREFIX);

			for (ClickGuiTab tab : iLnv_09.GUI.tabs) {
				printwriter.println(tab.getTitle() + "_x:" + tab.getX());
				printwriter.println(tab.getTitle() + "_y:" + tab.getY());
			}
			printwriter.println("armor_x:" + iLnv_09.GUI.armorHud.getX());
			printwriter.println("armor_y:" + iLnv_09.GUI.armorHud.getY());
			...
			System.out.println("[" + iLnv_09.NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + iLnv_09.NAME + "] Failed to load settings");
		}
	}
