...
import dev.iLnv_09.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        dev.iLnv_09.mod.modules.impl.render.Shader shaderChams = dev.iLnv_09.mod.modules.impl.render.Shader.INSTANCE;
