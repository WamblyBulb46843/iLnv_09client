...
import dev.iLnv_09.mod.modules.impl.combat.AutoWeb;
...
public class BlockUtil implements Wrapper {
    ...
    public static void placeBlock2(BlockPos pos, boolean rotate, boolean packet, boolean bypass) {
        if (airPlace()) {
            for(Direction i : Direction.values()) {
    ...
    public static boolean isHole(BlockPos pos) {
        ...
        for (BlockPos blockPos : holeBlocks) {
