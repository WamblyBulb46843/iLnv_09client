...
public class OyveyExplosionUtil implements Wrapper {
   ...
   public static float calculateDamage(double posX, double posY, double posZ, Entity entity, Entity predict, float power) {
      ...
      try {
         blockDensity = (double)Explosion.getExposure(vec3d, predict);
      ...
      if (entity instanceof LivingEntity) {
         finald = (double)getBlastReduction((LivingEntity)entity, getDamageMultiplied(damage), new Explosion(mc.world, entity, posX, posY, posZ, power, false, DestructionType.DESTROY));
      }
