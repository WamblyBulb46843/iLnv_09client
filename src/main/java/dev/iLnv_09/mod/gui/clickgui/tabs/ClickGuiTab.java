package dev.iLnv_09.mod.gui.clickgui.tabs;
...
import dev.iLnv_09.mod.gui.clickgui.components.impl.ModuleComponent;
...
public class ClickGuiTab extends Tab {
	...
	public ClickGuiTab(String title, int x, int y) {
		this.title = title;
		this.x = iLnv_09.CONFIG.getInt(title + "_x", x);
		this.y = iLnv_09.CONFIG.getInt(title + "_y", y);
		this.width = 98;
