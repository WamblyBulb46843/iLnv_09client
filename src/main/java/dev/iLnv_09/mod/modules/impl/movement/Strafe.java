...
import static dev.iLnv_09.api.utils.entity.MovementUtil.directionSpeed;
...
public class Strafe
    ...
    public void onStrafe(MoveEvent event) {
        if (mc.player.isSneaking() || HoleSnap.INSTANCE.isOn() || Speed.INSTANCE.isOn() || mc.player.isFallFlying() || iLnv_09.PLAYER.insideBlock || mc.player.isInLava() || mc.player.isTouchingWater() || mc.player.getAbilities().flying)
            return;
