...
public class ChestStealer extends Module {
    ...
    private final SliderSetting helmet = this.add(new SliderSetting("Helmet", 1, 0, 36, () ->take.getValue() && smart.isOpen()));
    private final SliderSetting chestplate = this.add(new SliderSetting("ChestPlate", 1, 0, 36, () -> take.getValue() && smart.isOpen()));
    private final SliderSetting leggings = this.add(new SliderSetting("Leggings", 1, 0, 36, () ->
            take.getValue() && smart.isOpen()
    ));
    private final SliderSetting boots = this.add(new SliderSetting("Boots", 1, 0, 36, () ->
            take.getValue() && smart.isOpen()));
    private final SliderSetting elytra = this.add(new SliderSetting("Elytra", 1, 0, 36, () ->
            take.getValue() && smart.isOpen()
    ));
    private final SliderSetting sword = this.add(new SliderSetting("Sword", 1, 0, 36, () -> take.getValue() && smart.isOpen()
    ));
    private final SliderSetting pickaxe = this.add(new SliderSetting("Pickaxe", 1, 0, 36, () ->
            take.getValue() && smart.isOpen()));
    ...
    private void update() {
        ...
        this.stealCountList[14] = (int)(this.helmet.getValue() - (double)InventoryUtil.getArmorCount(ArmorItem.Type.HELMET));
        this.stealCountList[15] = (int)(this.chestplate.getValue() - (double)InventoryUtil.getArmorCount(ArmorItem.Type.CHESTPLATE));
        this.stealCountList[16] = (int)(this.leggings.getValue() - (double)InventoryUtil.getArmorCount(ArmorItem.Type.LEGGINGS));
        this.stealCountList[17] = (int)(this.boots.getValue() - (double)InventoryUtil.getArmorCount(ArmorItem.Type.BOOTS));
        this.stealCountList[18] = (int)(this.elytra.getValue() - (double)InventoryUtil.getItemCount(Items.ELYTRA));
        this.stealCountList[19] = (int)(this.sword.getValue() - (double)InventoryUtil.getClassCount(SwordItem.class));
        this.stealCountList[20] = (int)(this.pickaxe.getValue() - (double)InventoryUtil.getClassCount(PickaxeItem.class));
    }
    ...
    private boolean needSteal(final ItemStack i) {
        ...
        if (InventoryUtil.CheckArmorType(i.getItem(), ArmorItem.Type.HELMET) && this.stealCountList[14] > 0) {
            this.stealCountList[14] -= i.getCount();
            return true;
        }
        if (InventoryUtil.CheckArmorType(i.getItem(), ArmorItem.Type.CHESTPLATE) && this.stealCountList[15] > 0) {
            this.stealCountList[15] -= i.getCount();
            return true;
        }
        if (InventoryUtil.CheckArmorType(i.getItem(), ArmorItem.Type.LEGGINGS) && this.stealCountList[16] > 0) {
            this.stealCountList[16] -= i.getCount();
            return true;
        }
        if (InventoryUtil.CheckArmorType(i.getItem(), ArmorItem.Type.BOOTS) && this.stealCountList[17] > 0) {
            this.stealCountList[17] -= i.getCount();
            return true;
        }
        if (i.getItem().equals(Items.ELYTRA) && this.stealCountList[18] > 0) {
            this.stealCountList[18] -= i.getCount();
            return true;
        }
        if (i.getItem() instanceof SwordItem && this.stealCountList[19] > 0) {
            this.stealCountList[19] -= i.getCount();
            return true;
        }
        if (i.getItem() instanceof PickaxeItem && this.stealCountList[20] > 0) {
            this.stealCountList[20] -= i.getCount();
            return true;
        }
        return false;
    }
