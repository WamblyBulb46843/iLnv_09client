...
import dev.iLnv_09.core.impl.ShaderManager;
...
public class Shader extends Module {
    ...
    public boolean shouldRender(Entity entity) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if (iLnv_09.FRIEND.isFriend((PlayerEntity) entity))
    ...
    public void onRender3D(MatrixStack matrixStack) {
        if (hands.getValue())
            iLnv_09.SHADER.renderShader(()-> mc.gameRenderer.renderHand(matrixStack, mc.gameRenderer.getCamera(), mc.getTickDelta()), mode.getValue());
    }

    @Override
    public void onToggle() {
        iLnv_09.SHADER.reloadShaders();
    }
