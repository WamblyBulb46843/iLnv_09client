...
public class AutoCity extends Module {
	...
	private boolean isObsidian(BlockPos pos) {
		return mc.player.getEyePos().distanceTo(pos.toCenterPos()) <= range.getValue() && (getBlock(pos) == Blocks.OBSIDIAN || getBlock(pos) == Blocks.ENDER_CHEST || getBlock(pos) == Blocks.CRYING_OBSIDIAN || getBlock(pos) == Blocks.NETHERITE_BLOCK || getBlock(pos) == Blocks.ANCIENT_DEBRIS || getBlock(pos) == Blocks.RESPAWN_ANCHOR) && BlockUtil.getClickSideStrict(pos) != null;
	}
