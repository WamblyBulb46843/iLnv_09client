...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(iLnv_09.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = iLnv_09.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = iLnv_09.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
